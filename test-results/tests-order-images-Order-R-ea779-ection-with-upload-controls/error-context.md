...
- Name: tests\order-images.test.js >> Order Request Images Feature >> should display Request Images section with upload controls
- Location: tests\order-images.test.js:18:5
