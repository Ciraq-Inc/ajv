      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center space-x-3">
          <div class="text-sm text-gray-600">
            <span class="font-semibold text-indigo-600">{{ formatNumber(stats?.total_master_products || 0) }}</span> Total Products
          </div>
          
          <button @click="refreshData" :disabled="loading" class="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-md hover:bg-indigo-200 transition-colors duration-200 flex items-center disabled:opacity-50">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr v-for="product in products" :key="product.id" class="hover:bg-gray-50 transition-colors">
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="h-12 w-12 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center border border-gray-200">
                  <img
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <div class="flex items-center space-x-2">
                  ...
                  >
                    <svg v-if="uploadingProductId === product.id" class="animate-spin h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24">
                      <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                      <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
        ...
        <div class="p-6">
          ...
          <div v-if="selectedProduct?.product_image_url" class="mb-4">
            ...
            <div class="w-full h-48 border-2 border-gray-200 rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center">
              <img :src="selectedProduct.product_image_url" alt="Current image" class="max-h-full max-w-full object-contain" />
            </div>
          </div>
