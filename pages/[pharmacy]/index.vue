...
<template>
  <div class="container mx-auto w-full px-4 py-6 max-w-7xl">
    ...
    <div
      v-else-if="pharmacyStore.notFound"
    ...
    <div v-else class="space-y-6">
      ...
      <div class="">
        ...
        >
          ...
          >
            ...
            <div
              class="bg-white rounded-full p-2 md:p-3 shadow-lg -mb-8 md:-mb-12 border-4 border-white"
            >
              ...
              <div v-else class="bg-indigo-50 rounded-full p-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-8 w-8 md:h-12 md:w-12 text-indigo-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div class="absolute right-0 bottom-0">
              ...
              >
                <path
                  d="M120 0v60H0C0 26.9 26.9 0 60 0s60 0 60 0z"
                  fill="white"
                />
              </svg>
            </div>
          ...
          <div class="p-4 pt-10 md:p-6 md:pt-16">
            ...
            >
              <div>
                ...
                <div
                  class="flex items-center mt-2 text-sm md:text-base text-gray-600"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4 md:h-5 md:w-5 mr-2 text-indigo-500"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
      ...
      >
        ...
        >
          <div class="flex items-center">
            <div
              class="bg-gradient-to-r from-indigo-100 to-purple-100 rounded-full p-3 mr-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="animate-fadeIn">
        ...
        <div
          v-if="!pharmacyStore.hasProducts && !searchQuery"
    ...
    <OrderSuccessModal
      :is-open="showOrderSuccessModal"
      :order-id="successOrderId"
      :order-summary="successOrderSummary"
...
const searchProducts = async (query) => {
  ...
  try {
    ...
    const response = await fetch(
      `${baseURL}/api/products/search?company_id=${
