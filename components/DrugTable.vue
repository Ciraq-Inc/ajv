  ...
  <div class="bg-white rounded-lg shadow-md overflow-x-auto">
    <table class="w-full">
      ...
      <tbody class="divide-y divide-gray-200">
        <tr v-for="drug in filteredDrugs" :key="drug.id" class="hover:bg-gray-50 transition-colors">
          ...
          <td class="p-3">
            <div class="flex items-center">
              <button @click="decreaseQuantity(drug)" :disabled="drug.quantity <= 1"
              ...
              <button @click="increaseQuantity(drug)"
          ...
          <td class="p-3">
            <button @click="handleAddToCart(drug)" :class="[
