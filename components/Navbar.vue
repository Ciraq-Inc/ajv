<template>
  <header class="py-8">
    ...
    >
      ...
      <div
        class="flex flex-col gap-y-4 lg:flex-row lg:gap-x-10 lg:gap-y-0 lg:items-center"
      >
        ...
        <div class="p-6">
          ...
          <ul class="space-y-4">
            <li class="flex items-center space-x-2">
              ...
              <nuxt-link
                to="/"
                class="text-secondary hover:text-text-green-800 transition-colors"
                @click="closeMobileNav"
              >
                Home
              </nuxt-link>
            ...
            <li class="flex items-center space-x-2">
              ...
              <a
                href="#services"
                class="text-secondary hover:text-green-800 transition-colors"
                @click="closeMobileNav"
              >
                Services
              </a>
            ...
            <li class="flex items-center space-x-2">
              ...
              <a
                href="mailto:rigelis@rigelis.co"
                class="text-secondary hover:text-green-800 transition-colors"
                @click="closeMobileNav"
              >
                Investor Relations
            ...
            <li>
              <div
                @click="toggleMobileResourceDropdown"
              ...
              <div
                v-if="mobileResourceDropdownOpen"
                class="pl-6 mt-2 space-y-2"
              >
                <nuxt-link
                  to="/locator"
                  class="block text-secondary hover:text-green-800"
                  @click="closeMobileNav"
                >
                  Locator
                </nuxt-link>
