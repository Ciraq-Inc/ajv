// services/admin/webAuthnService.js
//
...
//
// Factory pattern: identical to adminService.js — the caller injects
...
// (expectedOrigin + expectedRPID + counter checks). The browser API enforces
// origin binding before even returning the assertion, so a phishing page
// cannot produce a valid assertion for this RP ID.

export const createWebAuthnService = (api) => ({
  /**
   ...
   */
  verifyAuthentication(challengeId, assertionResponse) {
