...
export default {
  ...
  async getBalance(token) {
    const response = await fetch(`${API_BASE_URL}/sms-credits/balance`, {
      headers: {
  ...
  async getTransactions(filters = {}, token) {
    ...
    const response = await fetch(`${API_BASE_URL}/sms-credits/transactions?${params}`, {
      headers: {
        'Authorization': `Bearer ${token}`
      }
    })
  ...
  async topUpCredits(data, token) {
    const response = await fetch(`${API_BASE_URL}/sms-credits/admin/topup`, {
      method: 'POST',
      headers: {
  ...
  async topUpMoney(data, token) {
    const response = await fetch(`${API_BASE_URL}/sms-credits/admin/topup-money`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
  ...
  async getBillingHealth(token) {
    const response = await fetch(`${API_BASE_URL}/admin/billing/health`, {
      headers: {
        'Authorization': `Bearer ${token}`
      }
    })
  ...
  async getCompanyBillingHealth(companyId, token) {
    const response = await fetch(`${API_BASE_URL}/admin/billing/health/${companyId}`, {
      headers: {
        'Authorization': `Bearer ${token}`
      }
    })
  ...
  async runReconciliation(token) {
    const response = await fetch(`${API_BASE_URL}/admin/billing/reconcile`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`
      }
  ...
  async runCompanyReconciliation(companyId, token) {
    const response = await fetch(`${API_BASE_URL}/admin/billing/reconcile/${companyId}`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`
      }
  ...
  async getBillingIssues(filters = {}, token) {
    ...
    const response = await fetch(`${API_BASE_URL}/admin/billing/issues?${params}`, {
      headers: {
        'Authorization': `Bearer ${token}`
      }
    })
  ...
  async resolveIssue(issueId, data, token) {
    const response = await fetch(`${API_BASE_URL}/admin/billing/issues/${issueId}/resolve`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
  ...
  async getAuditLog(filters = {}, token) {
    ...
    const response = await fetch(`${API_BASE_URL}/admin/billing/audit?${params}`, {
      headers: {
        'Authorization': `Bearer ${token}`
      }
    })
