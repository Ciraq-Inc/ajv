...
import type { ApiInstance, ApiEnvelope, Ad } from '../types';

export const createAdsService = (api: ApiInstance) => ({
  /**
   ...
   * Returns: { data: Ad[] }
   */
  listPublic(companyId: number | string): Promise<ApiEnvelope<Ad[]>> {
